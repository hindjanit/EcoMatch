...
export default function AddProductPage() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      // -----------------------------
      // UPDATE SELLER LOCATION AGAIN
      // -----------------------------
      // This ensures latest location/name
      // is stored at submission time.
      ...
      <section className="mx-auto max-w-5xl px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Add product details, location
            and authentic images for
            verification.
          </p>
        ...
        >
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Upload authentic photos of the
              actual product. Maximum 5 images,
              5MB each.
            </p>
          ...
          <div className="rounded-2xl border border-[#cfe8dd] bg-[#eef9f4] p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Your listing and uploaded
              images will be submitted for
              admin verification. Only
              approved products will appear
              on the marketplace.
            </p>
